...
// Sección de pila tecnológica con iconos oficiales de marca
  ...
  return (
    <section id="stack" className="px-4 sm:px-6 py-20 sm:py-28 border-t border-border/30">
      <div className="mx-auto max-w-7xl">
          ...
          {tecnologias.map((tech, indice) => (
            <div key={tech.id}
              className={cn(
                ...
                "hover:border-primary/40 hover:bg-card/70 active:scale-[0.98] hover-lift animate-fade-in-up",
              )}
              style={{ animationDelay: `${indice * 60 + 200}ms` }}
            >
              {/* Degradado de hover */}
              <div className={cn(
              ...
              <div className="relative z-10 flex flex-col gap-4">
                {/* Icono de marca con fondo de color */}
                <div
        ...
        {/* Contador total */}
        <div className="mt-10 flex items-center gap-4 animate-fade-in-up stagger-4">
