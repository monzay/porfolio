...
// Página de Servicios — completamente traducida
export default function PaginaServicios() {
  const { t, language } = useTranslation()
  const ts = t.servicios

  // Genera la URL de WhatsApp con el mensaje por defecto según el idioma activo
    ...
    <div className="relative">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center">
            ...
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {/* Botón WhatsApp con mensaje por defecto */}
                <a
                  href={urlWa}
                  target="_blank"
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {servicios.map((servicio, indice) => {
              ...
              return (
                <article
                  key={servicio.id}
                  className={`group relative overflow-hidden rounded-xl border border-border/60 bg-card/40 glass p-6 sm:p-7 transition-all duration-400 hover:bg-card/70 active:scale-[0.99] hover-lift animate-fade-in-up ${servicio.borde}`}
                  style={{ animationDelay: `${(indice % 6) * 80 + 200}ms` }}
                >
                  {/* Degradado de hover */}
      ...
      <section className="px-4 sm:px-6 py-20 sm:py-28 border-t border-border/30">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-14 space-y-3 text-center animate-fade-in-up">
            <p className="font-mono text-xs uppercase tracking-[0.3em] text-primary">
              {ts.proceso.tagline}
            </p>
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {pasos.map((paso, indice) => {
              ...
              return (
                <div
                  key={paso.numero}
                  className="group relative rounded-xl border border-border/60 bg-card/40 glass p-7 transition-all duration-400 hover:border-primary/40 hover:bg-card/70 hover-lift animate-fade-in-up"
                  style={{ animationDelay: `${indice * 120 + 200}ms` }}
                >
      ...
      <section className="px-4 sm:px-6 py-20 sm:py-28 border-t border-border/30">
        <div className="mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl border border-primary/30 bg-primary/5 glass p-10 sm:p-16 text-center animate-scale-in">
            <div className="absolute inset-0 -z-10">
